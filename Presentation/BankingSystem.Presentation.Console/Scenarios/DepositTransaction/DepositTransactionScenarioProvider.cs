...
public class DepositTransactionScenarioProvider : IScenarioProvider
{
    private readonly IBankAccountService _service;
    private readonly ICurrentBankAccountService _currentBankAccount;

    public DepositTransactionScenarioProvider(
    ...
    public bool TryGetScenario([NotNullWhen(true)] out IScenario? scenario)
    {
        ...
        scenario = new DepositTransactionScenario(_service);
        return true;
    }
}